export const profile = {
  ...
  summary: 'I build polished web experiences with React, motion systems, and clean interaction details.',
...
export const helloPills = [
  { id: 'a', label: 'Design systems', icon: '▦', color: '#ff6a2b', side: 'left' },
...
export const skills = [
  {
    ...
    items: ['Figma', 'Framer', 'Webflow', 'Vercel', 'WordPress', 'Elementor', 'Avada', 'Experienced with AI builders'],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    items: ['Design tokens', 'Component libraries', 'Documentation', 'Accessibility audits'],
  },
  {
    id: 4,
    tag: 'Print & identity',
  ...
  },
  {
    ...
    items: ['Short-form content', 'Brand films', 'Motion graphics', 'Color & sound'],
  },
  {
    id: 7,
    tag: 'Growth',
    ...
    items: ['Campaign strategy', 'Ad creative', 'Email design', 'Analytics & reporting'],
  },
  {
    id: 8,
    tag: 'Always on',
    ...
    items: ['Content calendars', 'Reels & shorts', 'Community management', 'Paid social'],
  },
];

export const careerEntries = [
  { role: 'Creative Designer',          company: 'TryHackMe LLC',  period: '2025 – Current' },
  { role: 'Founder / Creative Director', company: 'DirectlyNik™',  period: '2023 – Current' },
